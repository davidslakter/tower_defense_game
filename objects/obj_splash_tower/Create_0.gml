...
shot_splash = true	// if the bullet does damage in an area

shot_dmg_min = 100	// minimum damage of bullet
shot_dmg_max = 150	// maximum damage of bullet
